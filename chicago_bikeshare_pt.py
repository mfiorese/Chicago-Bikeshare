...
print("Linha 0: ")
print(data_list[0])
# É a primeira linha do dicionário
...
# Nós podemos acessar as features pelo nome da coluna
# Por exemplo: sample['Gender'] para imprimir gênero
...
# Ótimo! Nós podemos pegar as linhas(samples) iterando com um for, e as colunas(features) pelo nome.
...
def column_to_list(data, column_name):
    ...
    """
    column_list = []
    # Dica: Você pode usar um for para iterar sobre as amostras, pegar a feature pelo seu nome, e dar append para uma lista
...
def most_popular_gender(data_list):
    """ 
        Função que retorna o genero com a maior quantidade
        Argumentos:
        data_list: list: Lista com os dados
...
def count_user_types(data_list):
    """ 
        ...
        Retorna: list: Lista com quantidade de assinantes e clientes respectivamente
    """
    subscriber = 0
    customer = 0
    dependent = 0
...
answer = "Porque existem registros com gênero não informado"
...
total_duration = int(trip_duration_list[0])
...
for trip_duration in trip_duration_list:
    ...
    total_duration +=  int(trip_duration)
...
trip_duration_list = [int(trip_duration) for trip_duration in trip_duration_list]
...
if sorted_list_len % 2 == 0:
    ...
    median_trip =  int(sorted_list[sorted_list_len // 2])
...
user_types = set()
start_stations_list = column_to_list(data_list, 'Start Station')
